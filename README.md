...
![Background Daemon and Scheduling Execution Logs](docs/daemon_demo.png)

### Structured Daemon Logs Output
![Structured JSON logs generated by the daemon](docs/log_demo.png)
